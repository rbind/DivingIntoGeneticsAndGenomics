...
abstract = "Introductory workshop for the Tunis R User Group on single-cell RNA-seq analysis using R and Seurat. Covers the complete scRNA-seq workflow from raw data processing to clustering, cell type annotation, and differential expression analysis with hands-on code examples."
abstract_short = ""
