...
abstract = "Technical webinar on using Principal Component Analysis (PCA) and Canonical Correlation Analysis (CCA) for single-cell RNA-seq cell type annotation. Explores dimensionality reduction techniques, reference-based annotation methods, and best practices for accurate cell type classification in scRNA-seq data."
abstract_short = ""
