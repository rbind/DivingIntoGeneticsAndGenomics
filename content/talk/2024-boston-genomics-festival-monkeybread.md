...
abstract = "Research presentation on using spatial transcriptomics to map myeloid and T cell interaction niches within the tumor microenvironment (TME). Demonstrates computational methods for analyzing spatial gene expression data to understand immune cell interactions and tumor immunology."
abstract_short = ""
