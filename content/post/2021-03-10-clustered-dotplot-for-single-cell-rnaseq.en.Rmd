...
Notice that in the `grid.cicle` call, we passed the percentage (0-1) as the radius for the circle.
When we make the dot size legend, we should make it consistent too.
...
## the size is the diameter of the points, need to * 2 
lgd_list = list(
    Legend( labels = c(0,0.25,0.5,0.75,1), title = "pt", type = "points", pch = 16, size = c(0,0.25,0.5,0.75,1)*2 * unit(2,"mm"),
