...
`Seurat` has a nice function for that. However, it can not do the clustering for the rows and columns. [David ] has written a [blog post](http://davemcg.github.io/post/lets-plot-scrna-dotplots/) using ggplot2 and ggtree from Guangchuang Yu. It looks great! 
...
col_fun = colorRamp2(c(-0.5, 2), c("#440154FF", "#FDE725FF"))
