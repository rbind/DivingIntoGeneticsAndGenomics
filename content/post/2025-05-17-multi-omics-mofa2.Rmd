...
**Tommy's NOTE: Read this paper by [Vivek et al Leveraging complementary multi-omics data integration methods for mechanistic insights in kidney diseases](https://pmc.ncbi.nlm.nih.gov/articles/PMC11949029/).**

They tested both `MOFA2`(unsupervisied) and `DIABLO` (supervised) for a pilot study in Chronic Kidney Disease.

A new preprint from Vivek and the group: [Multi-omics data integration from patients with carotid stenosis illuminates key molecular signatures of atherosclerotic instability](https://www.medrxiv.org/content/10.1101/2025.05.12.25327328v1).   
[Linkedin Post](https://www.linkedin.com/posts/vivek-das-phd-m-sc-b1110b25_happy-to-share-our-latest-preprint-where-activity-7329763931097399298-VAk8/).

**Those are good examples on how multi-omics data analysis is used in real-world applications!**
...
**A simple z-score normalization for each data modality worked.**

For more complex data, a robust method may be needed to normalize per data modality, learn modality-specific weights, or regularize appropriately (e.g., weighted PCA, MOFA2, DIABLO).
