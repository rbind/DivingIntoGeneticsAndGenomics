...
4. **Containers for the Win: Docker or Singularity**  
   ...
   - [Rocker Project](https://rocker-project.org) for R in Docker, or BioContainers for bio tools.
...
5. **Literate Programming: Mix Code and Words**  
   ...
   Bonus: Quartois Git-friendly if you avoid huge notebooks. Document outside too, like in my enhancer-promoter repo: https://gitlab.com/tangming2005/Enhancer_promoter_interaction_data.
