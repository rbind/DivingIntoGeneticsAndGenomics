...
The code can be better designed, and also add checks `...` using [`ellipsis`](https://ellipsis.r-lib.org/) package. Nevertherless, it is working and gives me desired layout :)
