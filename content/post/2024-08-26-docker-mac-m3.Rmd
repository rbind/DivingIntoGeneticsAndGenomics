...
My blogdown website [divingintogeneticsandgenomics.com](divingintogeneticsandgenomics.com) was using `Hugo v0.42` and `blogdown v1.0`. It has been many years and now I have a macbook pro with an M3 chip. I could not install the old versions of the R packages to serve the site. 
