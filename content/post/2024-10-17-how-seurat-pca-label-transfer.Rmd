...
# Get PCA embeddings/cell embeddings (U matrix) 
...
For cells without MNN, we can still assign labels based on the nearest neighbor from pbmc10k, but their transfer score will be lower (or zero):
